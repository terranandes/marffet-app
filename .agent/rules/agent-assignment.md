...
Basically for this project, we have the following agents by default. However, as required, the default agents shall be able to transform into a specialist/expert as `.agent/rules/GEMINI.md` describes. If you cannot select a close agent, stay as the default agent.
