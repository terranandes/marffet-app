...
- **BUG-003-PL (Portfolio Dividend Sync NaN):** 
...
- **BUG-004-UI (Date Picker Calendar Styles):** 
...
- Zeabur proxy caching remains healthy. Post-deployment, the previous TSMC discrepancy (BUG-002-PL, duplicated 2006 records) is successfully nullified and correctly reflects Mars tables identically.
